                    ...
                    <div className="dz-post-text">
                      ...
                      <figure className="wp-container-5 wp-block-gallery-2 wp-block-gallery has-nested-images columns-3 is-cropped alignwide">
                        <figure className="wp-block-image size-large">
                          <Image src={IMAGES.blogblock3} alt="" />
                        </figure>
                        <figure className="wp-block-image size-large">
                          <Image src={IMAGES.blogblock4} alt="" />
                        </figure>
                        <figure className="wp-block-image size-large">
                          <Image src={IMAGES.blogblock5} alt="" />
                        </figure>
                        <figure className="wp-block-image size-large">
                          <Image src={IMAGES.blogblock1} alt="" />
                        </figure>
                        <figure className="wp-block-image size-large">
                          <Image src={IMAGES.blogblock1} alt="" />
                        </figure>
                ...
                <div className="clear" id="comment-list">
                  <div className="post-comments comments-area style-1 clearfix">
                    <h4 className="comments-title mb-2">
                      Comments ({post.comments_list.length})
                    </h4>
                    <p className="dz-title-text">
                      Join the conversation — share your experience or ask our team a question.
                    </p>
                        ...
                        {post.comments_list.map((c, i) => (
                          <li
                            ...
                            className={`comment even ${
                              c.isReply ? "bypostauthor odd alt depth-2" : "thread-even depth-1"
                            } comment`}
                            id={`comment-${i + 2}`}
                          >
