  ...
  return (
    <>
      <header className="site-header header header-transparent style-2 header-light header-toggle">
          ...
          <div className="main-bar clearfix">
            <div className="container-fluid clearfix inner-bar">
              ...
              <div className="logo-header logo-light">
                <Link href="/">
                  <Image src={IMAGES.logowhite} alt="Signature Plus Clinic" />
                </Link>
              </div>
              ...
              <div
                className={
                  show === 3
                    ? "header-nav w3menu w3menu-start mo-left show"
                    : "header-nav w3menu w3menu-start mo-left"
                }
                id="W3Menu"
              >
                <div className="logo-header logo-dark">
                            ...
                            <ul className="demo-menu">
                              {data.content?.map((item, index) => (
                                <li key={item.id || index}>
                                  <Link href={item.to}>
                                    {item.image && <Image src={item.image} alt="demo" />}
        ...
        >
          ...
          <div className="offcanvas-body">
            <div className="widget">
              ...
              <p>
                Signature Plus Clinic provides advanced derma, dental, cosmetic, and hair
                restoration treatments with personalized care, modern technology, and a focus on
        ...
        <div
          className={`offcanvas dz-offcanvas offcanvas offcanvas-end ${show === 2 ? "show" : ""}`}
          tabIndex={-1}
          id="sidebarCart"
        >
          <button
